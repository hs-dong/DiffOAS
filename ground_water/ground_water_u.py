...
if __name__ == "__main__":
    ...
    if style == "GRF":
        fset = np.exp(GRF_w.sample(usample +1))
    ...
    # elif style == "cheb":
    #     fset = np.exp(Chebyshev_truncation_polynomial(s, cheby_num, usample+1))
    ...
    # reader = torch.load('water_train_252_fGRF.pt')
    ...
    torch.save(train_data,f"water_train_{train_resolution}_u{style}{train_num}.pt")

    torch.save(test_data,f"water_test_{train_resolution}_u{style}{train_num}.pt")
