...
if __name__ == "__main__":
    ...
    fset = np.exp(GRF.sample(num_examples+1))
    ...
    torch.save(train_data,f"acoustics_train_{train_resolution}_fGRF{alpha}_{k}.pt")

    torch.save(test_data,f"acoustics_test_{train_resolution}_fGRF{alpha}_{k}.pt")
